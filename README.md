...
На момент виконання завдання, сервер не відповідає!
Щоб потрапити на сторінку "Home", треба 3(три) рази невірно ввести данні на сторінці "Sign In =)

[DEMO LINK](https://uliton.github.io/authorization-form/)
